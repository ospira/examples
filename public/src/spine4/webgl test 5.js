...
function preload ()
{
    ...
    this.load.setPath('assets/spine/4.1/raptor').spine('raptor', 'raptor-pro.json', 'raptor-pma.atlas');
    this.load.setPath('assets/spine/4.1/vine').spine('vine', 'vine-pro.json', 'vine-pma.atlas');
    this.load.setPath('assets/spine/4.1/coin').spine('coin', 'coin-pro.json', 'coin-pma.atlas');
    this.load.setPath('assets/spine/4.1/tank').spine('tank', 'tank-pro.json', 'tank-pma.atlas');
}
